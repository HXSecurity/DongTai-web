export default {
  ...
  views: {
    ...
    vulnList: {
      ...
      developLanguage: 'select language',
      vulnStatus: 'select Status',
      ...
      clear: 'Cancel',
      enter: 'OK',
      verificationBatch: 'Batch Confirm',
      verificationAll: 'Full Confirm',
      chooseWarning:
        'Please select the vulnerability that needs to be confirm',
    ...
    projectDetail: {
      ...
      hasSame: 'Version Name is exists',
      warning: 'Prompt',
      warningInfo:
