  ...
  views: {
    ...
    deploy: {
      ...
      java: {
        ...
        p1:
          '若尚未启动 Web 应用服务器，请启动 Web 应用服务器。然后再浏览器访问应用。稍等1-2分钟，刷新系统配置页面，点击引擎管理，查看探针是否注册成功。如果没有注册成功，按照如下步骤进行排查：',
    ...
    agentManage: {
      ...
      enterDel: '确认删除',
      clear: '取消',
      agentDelInfo: '引擎删除后，相关的数据将一并删除，不可恢复',
      agentDelPop: '请确认是否删除？',
      running: '运行中',
      not_running: '未运行',
    ...
    projectEdit: {
      ...
      title: '基本设置',
      name: '项目名称',
      namePlaceholder: '格式：中文、英文字母大小写、数字、@等组合，长度20以内，名称保证唯一',
      mode: '扫描模式',
      mode1: '插桩模式',
      mode2: '流量模式',
      agent: '手动选择探针',
      agentPlaceholder: '请根据探针的名称选择要加入项目的探针',
      scan: '扫描策略',
      settings: '设置',
