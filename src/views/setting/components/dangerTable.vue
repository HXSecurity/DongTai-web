<template>
  <div class="table-body">
    <div>
      <el-button @click="dangerTypeDialog = true">添加规则类型</el-button>
      <el-button @click="dangerDialog = true">添加规则</el-button>
    </div>
    ...
    <el-dialog :visible.sync="dangerTypeDialog">
      <el-form :model="dangerType" label-width="80px">
        <el-form-item label="规则集">
          <span>{{ dangerType.key1 }}</span>
        </el-form-item>
        <el-form-item label="类型名称">
          <el-input v-model="dangerType.key2"></el-input>
        </el-form-item>
        <el-form-item label="类型简称">
          <el-input v-model="dangerType.key3"></el-input>
        </el-form-item>
        <el-form-item label="是否启用">
          <el-switch
            v-model="dangerType.key4"
            active-text="启用"
            inactive-text="禁用"
          ></el-switch>
        </el-form-item>
    ...
    <el-dialog :visible.sync="dangerDialog">
      <el-form :model="danger" label-width="80px">
        <el-form-item label="规则集">
          <span>{{ danger.key1 }}</span>
        </el-form-item>
        <el-form-item label="规则类型">
          <el-input v-model="danger.key2"></el-input>
        </el-form-item>
        ...
        <el-form-item label="继承深度">
          <el-radio v-model="danger.radio" label="1">仅当前类</el-radio>
          <el-radio v-model="danger.radio" label="2">仅子类</el-radio>
          <el-radio v-model="danger.radio" label="2">当前类及其子类</el-radio>
        </el-form-item>
      </el-form>
    </el-dialog>
  </div>
...
export default class DangerTable extends VueBase {
